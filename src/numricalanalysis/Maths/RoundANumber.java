...
public class RoundANumber extends JPanel {
    ...
    private JTextField jtfInputRoundingNumber = new JTextField();
    private JTextArea jtfOutputNumber = new JTextArea();
    private JLabel jlInputNumber;
    private JLabel jlInputRoundingNumber;
    private JLabel jlOutputNumber;
    private boolean up = true;

    public RoundANumber() {
        JPanel p1 = new JPanel();
        JPanel p2 = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 50));
        ...
        jbcalculate.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                jtfOutputNumber.setText(solve(jtfInputNumber.getText(), jtfInputRoundingNumber.getText()));
            }
        });
        ...
        jtfOutputNumber = new JTextArea();
        jlInputNumber = new JLabel("Input Number : ");
        jlInputRoundingNumber = new JLabel("Input Rounding Number : ");
        jlOutputNumber = new JLabel("Output Number : ");
        p2.add(jlInputNumber);
        p2.add(jtfInputNumber);
        p2.add(jlInputRoundingNumber);
        p2.add(jtfInputRoundingNumber);
        p2.add(jlOutputNumber);
        p2.add(jtfOutputNumber);
        jtfInputNumber.setPreferredSize(new Dimension(570, 40));
        jtfInputNumber.setEditable(false);
        jtfInputRoundingNumber.setEditable(false);
        jtfInputRoundingNumber.setPreferredSize(new Dimension(490, 40));
        jtfOutputNumber.setPreferredSize(new Dimension(550, 20));
        jtfOutputNumber.setEditable(false);
        jtfOutputNumber.setFont(new Font(Font.DIALOG, Font.BOLD, 20));
        jtfOutputNumber.setBackground(p2.getBackground());
        jtfInputNumber.setSize(new Dimension(400, 40));
        jtfInputRoundingNumber.setSize(new Dimension(400, 40));
        jtfOutputNumber.setSize(new Dimension(400, 40));
        jlInputNumber.setFont(new Font(Font.SERIF, Font.BOLD, 20));
        jlInputRoundingNumber.setFont(new Font(Font.SERIF, Font.BOLD, 20));
        jlOutputNumber.setFont(new Font(Font.SERIF, Font.BOLD, 20));
    ...
    private static String solve(String inputNumber, String inputRounding) {
        ...
        if (InputRounding >= number1.length()-1 && number1.contains(".")) {
